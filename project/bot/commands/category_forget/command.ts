...
export const options: CommandOptions = {
    name: "forget",
    description: "Will stop monitoring any set category.",
    category: "category",
    ignoreBots: true,
    args: [
        {
            name: "category",
            description: "The category to stop monitoring.",
            type: "String",
            required: true
        }
    ],
    ...
    execute: async (bot, context) => {
        ...
        if (memberValue) {
            ...
            if (memberJSON[context.interaction.data.options[0].value! as string]) {
                ...
                embed.setDescription("This category is no longer being monitored!");
        ...
        embed.setDescription("This category is not being monitored!");
